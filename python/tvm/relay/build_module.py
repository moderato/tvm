...
class BuildModule(object):
    ...
    def generate_code(self, mod, target=None, executor="graph", mod_name=None):
        """
        Parameters
        ----------
        mod : :py:class:`~tvm.IRModule`
        ...
        mod = self._generate_code(mod, target, mod_name)
        autotvm.GLOBAL_SCOPE.silent = old_autotvm_silent
...
def generate_code(ir_mod, target=None, target_host=None, params=None, mod_name='default'):

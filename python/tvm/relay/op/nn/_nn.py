...
# @reg.register_legalize("nn.fused_conv2d")
# def legalize_fused_conv2d(attrs, inputs, types):
#     """Legalize fused conv2d op.
...
#         The legalized expr
#     """
#     return topi.nn.fused_conv2d_legalize(attrs, inputs, types)

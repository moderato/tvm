...
TVM_REGISTER_GLOBAL("tvm.contrib.cudnn.grouped_conv2d.forward")
.set_body([](TVMArgs args, TVMRetValue *ret) {
  ...
  int stride_h = args[6];
  int stride_w = args[7];
  int dilation_h = args[8];
  int dilation_w = args[9];
  DLTensor *x = args[10];
  DLTensor *w = args[11];
  DLTensor *y = args[12];
...
TVM_REGISTER_GLOBAL("tvm.contrib.cudnn.grouped_conv2d.output_shape")
.set_body([](TVMArgs args, TVMRetValue *ret) {
  CuDNNThreadEntry* entry_ptr = CuDNNThreadEntry::ThreadLocal();
  int format = args[0];
  int group_count = args[1];
  int pad_h = args[2];
  int pad_w = args[3];
  int stride_h = args[4];
  int stride_w = args[5];
  int dilation_h = args[6];
  int dilation_w = args[7];
  int x_dim0 = args[8];
  int x_dim1 = args[9];
  int x_dim2 = args[10];
  int x_dim3 = args[11];
...
TVM_REGISTER_GLOBAL("tvm.contrib.cudnn.grouped_conv2d.find_algo")
.set_body([](TVMArgs args, TVMRetValue *ret) {
  CuDNNThreadEntry* entry_ptr = CuDNNThreadEntry::ThreadLocal();
  int format = args[0];
  int group_count = args[1];
